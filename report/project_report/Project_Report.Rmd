...
Now, it is more clear to say that the running time of the algorithm on non-Euclidean spaces is also $O(n\log n)$. All the ratio $r_n$ are close together and do not have the increment relationship as the outcome of run-time in seconds, see $r_n$ column of Figure \ref{fig:randomdatanonE}.
