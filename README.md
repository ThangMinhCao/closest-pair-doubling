...
> The implementation in C++ of the closest-pair doubling algorithm. The algorithm's theory is from the work of Anil Maheshwari, Wolfgang Mulzer and Michiel Smid.
